...
<body>
  ...
  <script>
    ...
    // Example usage:
    setProgressBar(0); // Set the progress directly without animation
    ...
    function getSoildMoitsureData() {
      var xhttp = new XMLHttpRequest();
      xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
          updateProgressBar(this.responseText); //Update Soild Moitsure Data
        }
      };
      xhttp.open("GET", "readSoilMoitsure", true);
      xhttp.send();
    }
    ...
    function getPlantGrowthData() {
      ...
      xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
          setProgressBar(this.responseText); //Update Plant Growth Data
        }
      };
      xhttp.open("GET", "readPlantGrowth", true);
      xhttp.send();
    }
